...
const TRANSITION_LAYER_SCENE_empty := preload("res://Scenes/transition_layer_empty.tscn")

@export var transition_duration : float = 2.0   # fade‑in / fade‑out seconds
@export var loading_duration    : float = 2.0   # “loading” hold
@export var max_intensity       : float = 0.4  # shader noise strength
...
func _ready() -> void:
	...
	layer = TRANSITION_LAYER_SCENE_empty.instantiate()
